    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#1a1d27] border border-[#2a2d3a] rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-[#64748b] text-sm mb-6">Start your AI-powered productivity journey</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="reg-username" className="block text-sm font-medium text-[#94a3b8] mb-1.5">
                Username
              </label>
              <input
                id="reg-username"
            ...
            <div>
              <label htmlFor="reg-email" className="block text-sm font-medium text-[#94a3b8] mb-1.5">
                Email
              </label>
              <input
                id="reg-email"
            ...
            <div>
              <label htmlFor="reg-password" className="block text-sm font-medium text-[#94a3b8] mb-1.5">
                Password
              </label>
              <input
                id="reg-password"
